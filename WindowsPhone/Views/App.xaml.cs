namespace Opuno.Brenn.WindowsPhone.Views
{
    ...
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            //Repository.Instance.Trips.LoadTrips();

            // set the frame DataContext
            //RootFrame.DataContext = ViewModel;

            this.pushTimer = new DispatcherTimer()
                {
                    Interval = new TimeSpan(0, 0, 0, 5)
                };

            this.pushTimer.Tick += (s, ea) => SyncHelper.Instance.Sync();
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            if (System.Diagnostics.Debugger.IsAttached)
            {
                Debug.WriteLine("Unhandled exception in Application: {0}", e.ExceptionObject.Message);
